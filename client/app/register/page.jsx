    ...
    <div className='w-full'>
      <div className='w-[90%] mx-auto border rounded-lg shadow-lg p-5 mt-7'>
        <div className='flex items-center justify-between'>
              ...
              <Link href="/login" className='flex items-center w-[10%] mx-5 my-3'>
                <p className='font-semibold border-2 rounded-xl px-3 py-2 border-[#19e619]'>Вход страница</p>
              </Link> 
        </div>
        ...
        <form onSubmit={handleRegister}>
          <div className='my-10 w-[70%] mx-auto'>
            ...
            <div>
              <p className='text-lg font-semibold text-[#273f27]'>Пароль *</p>
            ...
            <div className='mt-3'>
              ...
              <input className='mt-3 p-3 border border-[#273f27] rounded-lg w-[50%]' type="text" value={region} onChange={(e) => setRegion(e.target.value)} placeholder="Чилик" required/>
            </div>
            <div className='flex items-center space-x-1 mt-4'>
              <p>Уже есть аккаунт?</p>
              <button className='hover:border-b hover:border-[#273f27]' onClick={() => router.push('/login')}>Войдите!</button>
            </div>
            <button type="submit" className="flex w-[40%] mt-5 cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 flex-1 bg-[#19e619] text-[#111811] text-sm font-bold leading-normal tracking-[0.015em]">
